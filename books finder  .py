...
"background-color:#D3D3D3")
        ...
        self.pushButton.setGeometry(QtCore.QRect(320, 270, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton.clicked.connect(self.t3.clear)
        self.pushButton.clicked.connect(self.t1.clear)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Bestsellers Finder"))
    ...
    def FindPrice(self):
        book=sqlite3.connect('top20bestsellers.db')
        curbook=book.cursor()
        title=self.t1.text()
